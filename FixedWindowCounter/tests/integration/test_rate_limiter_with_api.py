...
# --------------------------------------------------------------------------------------
# Fixed Window Specific API Tests
# --------------------------------------------------------------------------------------
@pytest.mark.xfail(reason="Event loop issue with multiple requests")
@pytest.mark.asyncio
...
@pytest.mark.xfail(reason="Event loop issue with multiple requests")
@pytest.mark.asyncio
async def test_window_reset_allows_requests_after_window_expires(async_http_client: AsyncClient, test_redis_client, monkeypatch) -> None:
    monkeypatch.setattr("core.security.rate_limiter.redis_manager.redis_manager.client", test_redis_client)

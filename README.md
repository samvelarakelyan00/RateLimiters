...
| 4 | **Sliding Window Log** | ✅ Complete | Stores timestamps of every request; counts those within the last N seconds. Provides exact accuracy. | Financial systems, compliance‑critical applications that require perfect precision. |
